 ...
 * 
 * This function is intentionally left empty as the program utilizes FreeRTOS tasks
 * to perform all the necessary operations. The loop function is required by the 

/******  09d3da14-083d-409c-940d-d700194c819c  *******/
void loop(){
